...
while len(user_guesses) < 50:
    ...
    if state_guess == "Exit": # when typing exit, program will end
        missing_states = [state for state in all_states if state not in user_guesses] # this one line replaces the code written below, loops through all the states and if the state in not in my user_guesses will add to this new list.
        # missing_states = []
